...
const components: Record<string, React.ComponentType<any>> = {
  ...
  table: ({ className, ...props }: React.HTMLProps<HTMLTableElement>) => (
    <div className="my-6 w-full overflow-y-auto">
      <table className={cn("w-full", className)} {...props} />
    </div>
  ),
  tr: ({ className, ...props }: React.HTMLProps<HTMLTableRowElement>) => (
    <tr
      className={cn("m-0 border-t p-0 even:bg-muted", className)}
      {...props}
    />
  ),
  th: ({ className, ...props }: React.HTMLProps<HTMLTableCellElement>) => (
    <th
      className={cn(
  ...
  td: ({ className, ...props }: React.HTMLProps<HTMLTableCellElement>) => (
    <td
      className={cn(
